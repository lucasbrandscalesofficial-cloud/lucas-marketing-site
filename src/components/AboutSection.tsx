...
const AboutSection = () => {
  ...
  return (
    <section id="about" className="section-block relative overflow-hidden">
      ...
      <div
        ref={ref}
        className={`relative mx-auto flex max-w-5xl flex-col items-center gap-6 text-center sm:flex-row sm:gap-10 sm:text-left transition-[opacity,transform] duration-[5200ms] ease-[cubic-bezier(0.33,1,0.68,1)] motion-reduce:transition-none ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-2"}`}
      >
