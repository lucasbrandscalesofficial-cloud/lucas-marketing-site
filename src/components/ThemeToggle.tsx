...
const ThemeToggle = () => {
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-2 rounded-lg border border-border/80 bg-background/80 px-3 py-2 text-sm font-medium text-foreground shadow-sm ring-1 ring-black/[0.04] transition-colors duration-300 hover:border-primary/35 hover:bg-muted/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
