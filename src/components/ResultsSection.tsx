  ...
  return (
    <section id="results" className="section-alt section-block relative overflow-hidden">
      ...
      <div ref={ref} className="relative mx-auto max-w-6xl">
        <div
          className={`mb-10 text-center transition-all duration-[3200ms] ease-[cubic-bezier(0.25,0.46,0.45,0.94)] ${visible ? "opacity-100 translate-y-0 blur-0" : "opacity-0 translate-y-3 blur-[2px]"}`}
        >
        ...
        <div
          className={`transition-all delay-100 duration-[3200ms] ease-[cubic-bezier(0.25,0.46,0.45,0.94)] ${visible ? "opacity-100 translate-y-0 blur-0" : "opacity-0 translate-y-3 blur-[2px]"}`}
        >
          <div className="flex flex-col items-stretch gap-10 lg:flex-row lg:items-center lg:justify-center lg:gap-6 xl:gap-10">
            {/* Before */}
            <div
              className={`min-w-0 flex-1 transition-all duration-[2600ms] ease-[cubic-bezier(0.25,0.46,0.45,0.94)] lg:max-w-[min(100%,420px)] ${visible ? "translate-y-0 opacity-100" : "translate-y-2 opacity-0"}`}
